...
public class CreateTicket {
    ...
    public boolean equals(Object o) {
        ...
        CreateTicket that = (CreateTicket) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, queue, requestor, subject, cc, adminCc, owner, status, priority, initialPriority, finalPriority, timeEstimated, starts, due, text, customFields);
    }
}
